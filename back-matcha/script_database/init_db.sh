mysql -u root --password=passwd matcha -e "CREATE TABLE IF NOT EXISTS USER (
      ...
      genre1 ENUM('male', 'female') NOT NULL COMMENT 'Genre de naissance (Homme,Femme)',
      genre2 ENUM('cisgender', 'transgender', 'non binary', 'queer', 'fluid') NOT NULL COMMENT 'Genre vecu et exprime',
